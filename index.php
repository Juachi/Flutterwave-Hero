...
<nav class="navbar navbar-expand-sm bg-light navbar-light justify-content-center fixed-top">
  <a class="nabar-brand ">
    <img class="img-overlay" src="logo.png" style="width:100px;">
  </a>  
</nav>
...
if(isset($_GET['email'])){
  ...
  $redirect_url = "http://52.29.85.40/raar/index.php";
  $payment_plan = "shoestore" ;// this is only required for recurring payments.
...
?>  
  <div id="unsuccessfull" class="">
      <h3>Sorry! It seems there was an error with your purchase. Please try <a class="" href="http://52.29.85.40/raar/index.php">again.</a><br>
...
<div class="container col-sm-4" style="margin-top:80px">
  ...
  <div class="card">
    <h3 class="card-title " style="text-align:center;">Do you want to buy this item? </h3>
      <img src="https://static-naija.akamaized.net/vllkyt5t3b0sv75lk.911c2f2c.jpg" class="img-thumbnail img-fluid">

    <div class="card-body">
      <p class="card-text" style="text-align:center;">Handmade Ankara Sandals for Women <span class="badge badge-info">N3000</span></p>
    </div>
      <button class="btn btn-primary " data-toggle="collapse" data-target="#buy">Proceed</button>
